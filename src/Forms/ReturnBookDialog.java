...
//		formular.book = (Book) bookComboBox.getValue();
	...
	protected void setInfo()
	{
		...
		var model = returnDateTimePicker.getModel();
		model.setDate(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DAY_OF_MONTH));
		model.setSelected(true);

		boolean flag = formular.issueDate == null;
		issueDateTimePicker.setEnabled(flag);
		Date issueDate = flag ? new Date() : formular.issueDate;				
		{
			model = issueDateTimePicker.getModel();
